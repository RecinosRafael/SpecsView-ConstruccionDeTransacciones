...
import RazonesDeReversaPomCy from "../support/PageObjects/Specs-view-PO/RazonDeReversoPom.cy";

const Generales = new metodosGeneralesPomCy()
const RazonesReversa = new RazonesDeReversaPomCy()


describe("Prueba unitaria del Crud Razones de reversion ...", () =>{
