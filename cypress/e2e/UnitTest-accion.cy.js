...
import AccionesPomCy from "../support/PageObjects/Specs-view-PO/AccionesPom.cy";

const Generales = new metodosGeneralesPomCy()
const Accion = new AccionesPomCy()


describe("Prueba unitaria del Crud Acciones ...", () =>{
    ...
    it("Agregar múltiples registros dinámicamente", () => {
        cy.readFile('./JsonData/acciones.json').then((data) => {
            cy.wrap(data.agregar).each((item, index) => {
                ...
                // Llenar datos
                Accion.Accion(
                    //codigo, nombre, descripcion, ValorTipoAccion 
                    item.codigo, 
                    item.nombre,   
                    item.descripcion, 
                    item.ValorTipoAccion
                )
