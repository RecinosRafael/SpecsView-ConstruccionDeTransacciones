...
describe("Prueba unitaria del submenu del Crud DivGeografica...", () =>{
    ...
    it("Agregar registros a sub nivel", function () {
        ...
        cy.wrap(Object.keys(agrupadas)).each((codigoDiv) => {
                ...
                cy.wrap(Object.keys(subgrupos)).each((codigoDiv2) => {
                    ...
                    cy.wrap(subgrupos[codigoDiv2]).each((item) => {
                        ...
                        cy.log('🔙 Regresando al nivel anterior')
                        ...
                        return cy.then(() => {
                            ...
                            // Segundo regreso - SALIR DEL divicion geografica 2
                            cy.wait(3000)
                            Generales.Regresar()
                    ...
                    })//AQUI TERMINA LA SEGUNDA AGRUPACION                    
                    }).then(() => {
                        cy.log('🔙 Regresando al nivel anterior')
        ...
        })//AQUI TERMINA LA PRIMERA AGRUPACION

    })//AQUI TERMINA EL IT

})//AQUI TERMINA EL DESCRIBE
